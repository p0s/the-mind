...
[NOTE] The phenomenology ("I feel hungry") is how this control state appears to the system; the functional role is to steer behavior toward states that restore viability.

[NOTE] A second example: the "cookies" perspective.
