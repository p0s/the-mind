...
- and what counts as success or failure for me. <!-- src: yt_UkAOHrbcnAs @ 00:16:47 -->
...
When perception is organized around a point of view, the self is experienced as the one for whom things matter.
When action is selected, the self is experienced as the author.
When memory is compressed, the self becomes the thread linking episodes across time.
When society responds, the self becomes the public face of commitments and roles. <!-- src: yt_CcQMYNi9a2w @ 00:25:57 -->
...
- **consciousness**: the special mode in which content is present. <!-- src: web_cimc_ai_cimchypothesis_pdf @ p12-16 -->
...
Narrative is the compressed story that makes those answers coherent across time and legible to other people. <!-- src: yt_CcQMYNi9a2w @ 00:25:57 -->
...
It compresses.
It rationalizes.
It can overstate coherence.
It can hide fragmentation.
It can become rigid.
It can be hijacked by social pressure or old habit.
...
A country is not a particle.
A company is not a molecule.
A line on a map is not visible under a microscope.
...
> the mind’s model of itself as an agent with a point of view, boundaries, concerns, commitments, and a story across time. <!-- src: yt_UkAOHrbcnAs @ 00:16:47; yt_CcQMYNi9a2w @ 00:25:57; web_cimc_ai_cimchypothesis_pdf @ p15-16 -->
