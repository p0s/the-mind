...
Consciousness is not the same thing as the self. The paper says this very directly: **consciousness is not synonymous with self, mind, or intellect**. <!-- src: web_cimc_ai_cimchypothesis_pdf @ p12 -->
...
- it should capture phenomenology,
- explain function,
- and ideally explain genesis. <!-- src: web_cimc_ai_cimchypothesis_pdf @ p12 -->
...
General computational machines with sufficient resources may possess the necessary and sufficient means to implement consciousness, **but that does not imply current computers are conscious**. <!-- src: web_cimc_ai_cimchypothesis_pdf @ p6-8 -->
...
- web_cimc_ai_cimchypothesis_pdf @ p3-4
- web_cimc_ai_cimchypothesis_pdf @ p6-8
- web_cimc_ai_cimchypothesis_pdf @ p12-13
